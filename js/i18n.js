...
const DICT = {
  en: {
    ...
    'start.controls': `
      ...
      <div class="cline"><b>Z</b> — sound on/off (engine hum, cockpit clicks, impacts — off by default).</div>`,
  ...
  ru: {
    ...
    'start.controls': `
      ...
      <div class="cline"><b>Z</b> — звук вкл/выкл (гул двигателя, щелчки приборов, удары — по умолчанию выключен).</div>`,
